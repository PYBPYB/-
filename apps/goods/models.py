...
class GoodsSKU(BaseModel):
    ...
    status = models.SmallIntegerField(default=1, choices=status_choices, verbose_name='是否上架')
...
class IndexGoodsBanner(BaseModel):
    ...
    def __str__(self):
        return '%s %s' % (self.sku.name, self.index)
...
class IndexTypeBanner(BaseModel):
    ...
    display_type = models.SmallIntegerField(default=1, choices=DISPLAY_TYPE, verbose_name='展示方式')
    index = models.SmallIntegerField(default=0, verbose_name='展示顺序')
